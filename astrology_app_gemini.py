...
print("Let's build an astrology app together with Gemini AI!")
...
class GeminiAstrologyInterpreter:
    ...
    def __init__(self):
        ...
        if not self.api_key:
            print("⚠️  Google API key not found. Set GOOGLE_API_KEY environment variable for AI features.")
...
"""
    ...
    def get_ai_interpretation(self, kundali_data: Dict, question: str) -> str:
        ...
        try:
            ...
            print(f"⚠️  Gemini interpretation error: {e}")
            return self.get_fallback_interpretation(kundali_data, question)
...
def display_kundali(kundali_data):
    ...
    print("\n" + "="*60)
    print("🌟 YOUR KUNDALI (BIRTH CHART) - GEMINI VERSION 🌟")
    print("="*60)
...
def gemini_astrology_consultation(kundali_data):
    """AI-powered astrology consultation using Gemini Pro"""
    print("\n" + "="*60)
    print("🤖 GEMINI AI ASTROLOGY CONSULTATION")
    print("="*60)
    ...
    print("• 'How can I work with my Saturn placement for personal growth?'")
    ...
    while True:
        ...
        print("\n" + "="*60)
        print("🌟 GEMINI AI ASTROLOGICAL INTERPRETATION")
        print("="*60)
...
def main():
    print("\n" + "="*50)
    print("🌟 WELCOME TO YOUR PERSONAL ASTROLOGY APP (GEMINI VERSION) 🌟")
    print("="*50)
    ...
    print(f"\nHello, {name}! Let's explore the mystical world of astrology with Gemini AI!")
    ...
    while True:
        ...
        print("6. 🤖 Gemini AI Astrology Consultation (Ask Questions)")
        print("7. 🚪 Exit")
        print("="*50)
        ...
        if choice == '1':
            ...
            print("\n" + "="*50)
            print("🔮 COMPLETE ASTROLOGICAL PROFILE (GEMINI VERSION)")
            print("="*50)
            basic_astrology_reading()
            print("\n" + "-"*30)
            daily_crystal_reading()
            ...
            print("\n" + "="*50)
            print("🕉️ KUNDALI GENERATION (GEMINI VERSION)")
            print("="*50)
            ...
            if current_kundali is None:
                ...
                print("   This will provide the data needed for Gemini AI analysis.")
            else:
                gemini_astrology_consultation(current_kundali)
            
        elif choice == '7':
            print("\n" + "="*50)
            print("Thank you for using the Astrology App (Gemini Version)! 🌟")
